...
const EditClient: React.FC<EditClientProps> = ({ clientId, onCancel }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onCancel(); // Return to profile view
    } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Edit Client</h1>
